...
public class BookServiceImpl implements BookService {
	...
	public Iterable<BookDto> findBooksByPublisher(String publisherName) {
		...
		return publisherRepository.findByPublisherName(publisherName).map(p -> modelMapper.map(p, BookDto.class))
				.collect(Collectors.toList());
	}
	...
	public Iterable<AuthorDto> findBookAuthors(Long isbn) {
		// TODO Auto-generated method stub
		return authorRepository.findByAuthor(isbn).map(a -> modelMapper.map(a, AuthorDto.class))
				.collect(Collectors.toList());
	}
	...
	public Iterable<String> findPublishersByAuthor(String authorName) {
		// TODO Auto-generated method stub
		return publisherRepository.findByPublisherByAuthor(authorName)
		.map(p -> modelMapper.map(p, String.class))
		.collect(Collectors.toList());
}
	...
	public AuthorDto removeAuthor(String authorName) {
		...
		bookRepository.deleteById(authorName);
